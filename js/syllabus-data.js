const CATEGORIES = {
  java: { label: "Core Java", color: "var(--teal)", bg: "rgba(45,212,191,0.1)" },
  oop: { label: "OOP", color: "var(--purple)", bg: "rgba(167,139,250,0.1)" },
  collections: { label: "Collections", color: "var(--accent)", bg: "rgba(201,168,76,0.1)" },
  dsa_basic: { label: "DSA: Basic", color: "#BA7517", bg: "rgba(186,117,23,0.1)" },
  dsa_mid: { label: "DSA: Intermediate", color: "#D85A30", bg: "rgba(216,90,48,0.1)" },
  dsa_adv: { label: "DSA: Advanced", color: "#A32D2D", bg: "rgba(163,45,45,0.1)" },
  interview: { label: "Interview Prep", color: "var(--teal)", bg: "rgba(45,212,191,0.1)" },
  competitive: { label: "Competitive Prog.", color: "var(--purple)", bg: "rgba(167,139,250,0.1)" },
  design: { label: "Design Patterns", color: "var(--accent)", bg: "rgba(201,168,76,0.1)" },
  capstone: { label: "Capstone", color: "var(--text-primary)", bg: "rgba(255,255,255,0.1)" },
};
